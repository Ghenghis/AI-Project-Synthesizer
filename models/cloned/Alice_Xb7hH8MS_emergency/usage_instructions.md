# Emergency Voice Backup: Alice_Xb7hH8MS

## Overview
This is an emergency backup of the Alice_Xb7hH8MS voice created from extracted ElevenLabs samples.
...
backup_dir = Path("models\cloned\Alice_Xb7hH8MS_emergency")
...
local_voice = VoiceProfile(
    id="Alice_Xb7hH8MS_emergency",
    name="Alice_Xb7hH8MS (Emergency)",
    provider=VoiceProvider.LOCAL,
    voice_id="Alice_Xb7hH8MS_emergency",
