# Emergency Voice Backup: Eric_cjVigY5q

## Overview
This is an emergency backup of the Eric_cjVigY5q voice created from extracted ElevenLabs samples.
...
backup_dir = Path("models\cloned\Eric_cjVigY5q_emergency")
...
local_voice = VoiceProfile(
    id="Eric_cjVigY5q_emergency",
    name="Eric_cjVigY5q (Emergency)",
    provider=VoiceProvider.LOCAL,
    voice_id="Eric_cjVigY5q_emergency",
