# Emergency Voice Backup: Lily_pFZP5JQG

## Overview
This is an emergency backup of the Lily_pFZP5JQG voice created from extracted ElevenLabs samples.
...
backup_dir = Path("models\cloned\Lily_pFZP5JQG_emergency")
...
local_voice = VoiceProfile(
    id="Lily_pFZP5JQG_emergency",
    name="Lily_pFZP5JQG (Emergency)",
    provider=VoiceProvider.LOCAL,
    voice_id="Lily_pFZP5JQG_emergency",
