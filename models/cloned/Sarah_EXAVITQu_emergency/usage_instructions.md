# Emergency Voice Backup: Sarah_EXAVITQu

## Overview
This is an emergency backup of the Sarah_EXAVITQu voice created from extracted ElevenLabs samples.
...
backup_dir = Path("models\cloned\Sarah_EXAVITQu_emergency")
...
local_voice = VoiceProfile(
    id="Sarah_EXAVITQu_emergency",
    name="Sarah_EXAVITQu (Emergency)",
    provider=VoiceProvider.LOCAL,
    voice_id="Sarah_EXAVITQu_emergency",
