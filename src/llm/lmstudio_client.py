...
class LMStudioClient:
    ...
    async def is_available(self) -> bool:
        ...
        try:
            ...
            secure_logger.info(
                f"LM Studio health check successful",
            ...
            secure_logger.warning(
                f"LM Studio health check failed",
                correlation_id=correlation_id,
                error=str(e)[:200]
            )
    ...
    async def list_models(self) -> List[str]:
        ...
        try:
            ...
            secure_logger.error(
                f"Failed to list LM Studio models",
                correlation_id=correlation_id,
                error=str(e)[:200]
            )
    ...
    async def complete(
        ...
        secure_logger.info(
            f"LM Studio completion request",
            correlation_id=correlation_id,
            model=model,
        ...
        try:
            ...
            secure_logger.info(
                f"LM Studio completion successful",
                correlation_id=correlation_id,
                model=model,
                tokens_used=tokens_used,
                duration_ms=duration_ms
    ...
    async def get_model_info(self, model: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            secure_logger.error(
                f"Failed to get LM Studio model info",
                correlation_id=correlation_id,
                model=model,
                error=str(e)[:200]
            )
