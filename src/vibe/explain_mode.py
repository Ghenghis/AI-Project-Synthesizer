...
class ExplainMode:
    ...
    async def explain_code_change(self, change: CodeChange, 
                                 ...
                                 level: Optional[ExplanationLevel] = None) -> Explanation:
        """
    ...
    def _classify_change(self, change: CodeChange, context: Optional[Dict[str, Any]]) -> ExplanationType:
...
{{
    ...
    def get_explanation_history(self, exp_type: Optional[ExplanationType] = None) -> List[Explanation]:
