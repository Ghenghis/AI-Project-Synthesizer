...
from src.vibe.context_manager import ContextManager, Checkpoint
...
class AutoRollback:
    ...
    async def create_rollback_point(self, task_id: str, phase_id: str, 
                                  ...
                                  files: Optional[List[str]] = None) -> RollbackPoint:
        """
    ...
    async def rollback_on_failure(self, task_id: str, phase_id: str, 
                                failure_reason: str, 
                                rollback_point: Optional[RollbackPoint] = None) -> RollbackResult:
        """
    ...
    async def _rollback_files(self, file_backup: Dict[str, Any]) -> Dict[str, Any]:
        ...
        backup_path = Path(file_backup["backup_path"])
    ...
    async def _get_latest_rollback_point(self, task_id: str, phase_id: str) -> Optional[RollbackPoint]:
    ...
    def get_rollback_history(self, task_id: Optional[str] = None) -> List[RollbackResult]:
