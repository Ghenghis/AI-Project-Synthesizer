...
'''
    ...
    async def _generate_function_tests(self, func_info: Dict[str, Any], language: str, class_name: Optional[str] = None) -> List[TestFunction]:
...
{{
    ...
    def _generate_fallback_tests(self, func_info: Dict[str, Any], language: str, class_name: Optional[str] = None) -> List[TestFunction]:
...
""")
    ...
    def _estimate_coverage(self, functions: List[Dict[str, Any]], classes: List[Dict[str, Any]], test_functions: List[TestFunction]) -> float:
        ...
        tested_items = len(set(tf.target_function for tf in test_functions))
