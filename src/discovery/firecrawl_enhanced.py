...
from .firecrawl_client import FirecrawlClient, ScrapedContent, FirecrawlFormat
...
class FirecrawlEnhanced(FirecrawlClient):
    ...
    async def _get_from_cache(self, key: str) -> Optional[ScrapedContent]:
    ...
    async def scrape_url_enhanced(
        self,
        url: str,
        formats: Optional[List[FirecrawlFormat]] = None,
